        ...
        <section className="fade-in">
          ...
          <div className="space-y-3 max-w-[54ch] mx-auto lg:mx-0 text-left">
            <p className="text-base sm:text-lg font-semibold text-white leading-relaxed">
              ...
              <span className="text-gray-300">(HÌnh ảnh + Âm thanh + Video)</span>
            </p>
            <p className="text-sm sm:text-[15px] text-gray-300/95 leading-7 text-justify">
              Dự án <b>Emotion AI Analyzer</b> là một <b>Đồ án Tốt nghiệp</b> ngành <b>Khoa học máy tính</b>, tập trung
              vào việc phát triển một hệ thống toàn diện có khả năng phân tích và nhận diện cảm xúc của người dùng từ dữ
              liệu <b>đa phương thức</b>, bao gồm <b>hình ảnh</b>, <b>âm thanh</b>, và <b>video</b>.
            </p>
          </div>
        </section>
      ...
      <div className="relative w-full py-6 px-4">
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-sm text-gray-400 text-center md:text-left">
            <p>
              Emotion AI Analyzer —{" "}
              <span className="text-gray-300">Nhận diện cảm xúc đa phương thức (Image • Audio • Vision)</span> ©{" "}
